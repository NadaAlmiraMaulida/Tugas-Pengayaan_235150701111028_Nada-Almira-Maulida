    ...
    public void tampilkanDaftarMeja() {
        for (int i = 0; i < daftarMeja.length; i++) {
            if (daftarMeja[i].isKosong()) {
                ...
                System.out.println("Meja " + daftarMeja[i].getNomorMeja() + " terisi oleh "+daftarMeja[i].getPelangganNames());
            }
        }
    }
            ...
            switch (pilihan) {
                ...
                case 5:
                    ...
                    if (totalHarga == 0) {
                        ...
                        System.out.println("Harga pesanan dimeja "+nomorMejaHitung+" adalah " + totalHarga);
                    }
                    break;
                ...
                case 6:
                    ...
                    scanner.nextLine();
                    int price = hitungHargaPesanan(nomorMejaTampil);
                    if (price == 0) {
                        System.out.println("Meja "+nomorMejaTampil+" tidak memiliki pesanan");
                    }
